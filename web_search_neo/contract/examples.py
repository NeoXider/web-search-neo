...
_RECIPES = {
    ...
    "macro": [
        ...
        "macro validate until valid, then preview {variables}",
    ...
    "game": [
        ...
        "input {key_actions/pointer_actions} or step {frames}", "screenshot or game_probe between batches",
    ...
    "release_check": ["security_report {url}", "fix priority[] top-down, rerun",
...
_PITFALLS = [
    ...
    "Repeated text is not identity: match exact href/value/attributes, or click_text exact text + role; never nth-child alone.",
