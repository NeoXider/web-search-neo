...
_SKILL_SECTIONS: dict[str, dict[str, Any]] = {
    ...
    "audit": {
        "summary": "Check your own site before a release: security grade, API traffic, performance, third parties.",
        ...
        "steps": [
            ...
            "secret_scan {url}: secrets, endpoints, openapi, sourcemaps and agent files in the page's own scripts; sign-in forms; values masked, third-party scripts named only.",
            "secret_scan scope='site' crawls your site and scope='hosts' reads several origins (served HTML, no browser); sections merge into one priority[]; active_probe scope='hosts' probes each origin's front page.",
