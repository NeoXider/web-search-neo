...
It describes version 1.18.0. The Python package, the server, and the bundled Chrome
...
The bundled companion is version 1.18.0 and declares five permissions: `alarms`, `debugger`,
...
3. Check the card's version. It must read 1.18.0; anything older speaks bridge protocol 1
