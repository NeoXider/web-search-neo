...
It describes version 1.18.5. The Python package, the server, and the bundled Chrome
...
The bundled companion is version 1.18.5 and declares five permissions: `alarms`, `debugger`,
...
3. Check the card's version. It must read 1.18.5; anything older speaks bridge protocol 1
