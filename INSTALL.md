...
It describes version 1.18.2. The Python package, the server, and the bundled Chrome
...
The bundled companion is version 1.18.2 and declares five permissions: `alarms`, `debugger`,
...
3. Check the card's version. It must read 1.18.2; anything older speaks bridge protocol 1
